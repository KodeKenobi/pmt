...
export default function NotFound() {
  return (
    <main className="relative flex min-h-screen overflow-hidden bg-[#121314] text-white">
      ...
      <div className="relative mx-auto grid min-h-screen w-full max-w-6xl grid-rows-[auto_1fr_auto] px-7 py-8 sm:px-12 sm:py-10">
        <header className="flex items-center gap-3 text-sm font-semibold tracking-wide">
          <span>Lighthouse</span>
          <span className="text-white/40">Project Management</span>
        </header>
        ...
        <section className="max-w-xl pt-6 sm:pt-10">
          ...
          <div className="mt-8 flex flex-wrap gap-3">
            <Link
              href="/auth/login"
              style={{ color: "#121314" }}
              className="inline-flex items-center gap-2 bg-white px-5 py-3 text-sm font-semibold text-[#121314] transition hover:bg-white/85 focus-visible:outline-2 focus-visible:outline-offset-4 focus-visible:outline-white"
            >
