...
import * as routeModule from '@/app/api/admin/invite/route';
...
describe('src/app/api/admin/invite/route.ts', () => {
  it('POST returns an HTTP response object', async () => {
    const handler = routeModule.POST;
    const request = new NextRequest('http://localhost/api/admin/invite?take=10&page=1', {
      method: 'POST',
