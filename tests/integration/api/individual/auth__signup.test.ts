...
import * as routeModule from '@/app/api/auth/signup/route';
...
describe('src/app/api/auth/signup/route.ts', () => {
  it('POST returns an HTTP response object', async () => {
    const handler = routeModule.POST;
    const request = new NextRequest('http://localhost/api/auth/signup?take=10&page=1', {
      method: 'POST',
