...
import * as routeModule from '@/app/api/automation-rules/route';
...
describe('src/app/api/automation-rules/route.ts', () => {
  it('GET returns an HTTP response object', async () => {
    const handler = routeModule.GET;
    const request = new NextRequest('http://localhost/api/automation-rules?take=10&page=1', {
      method: 'GET',
