...
import * as routeModule from "@/app/api/client/projects/route";
...
describe("src/app/api/client/projects/route.ts", () => {
  it("GET returns an HTTP response object", async () => {
    const handler = routeModule.GET;
    const request = new NextRequest(
      "http://localhost/api/client/projects?take=10&page=1",
      {
        method: "GET",
