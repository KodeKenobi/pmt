...
import * as routeModule from '@/app/api/clients/route';
...
describe('src/app/api/clients/route.ts', () => {
  it('GET returns an HTTP response object', async () => {
    const handler = routeModule.GET;
    const request = new NextRequest('http://localhost/api/clients?take=10&page=1', {
      method: 'GET',
