...
import * as routeModule from '@/app/api/clients/[id]/route';
...
describe('src/app/api/clients/[id]/route.ts', () => {
  it('PATCH returns an HTTP response object', async () => {
    const handler = routeModule.PATCH;
    const request = new NextRequest('http://localhost/api/clients/id-test?take=10&page=1', {
      method: 'PATCH',
