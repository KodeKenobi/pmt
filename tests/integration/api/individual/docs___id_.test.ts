...
import * as routeModule from '@/app/api/docs/[id]/route';
...
describe('src/app/api/docs/[id]/route.ts', () => {
  it('GET returns an HTTP response object', async () => {
    const handler = routeModule.GET;
    const request = new NextRequest('http://localhost/api/docs/id-test?take=10&page=1', {
      method: 'GET',
