...
import * as routeModule from '@/app/api/github/auth/route';
...
describe('src/app/api/github/auth/route.ts', () => {
  it('GET returns an HTTP response object', async () => {
    const handler = routeModule.GET;
    const request = new NextRequest('http://localhost/api/github/auth?take=10&page=1', {
      method: 'GET',
