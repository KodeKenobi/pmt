...
import * as routeModule from '@/app/api/github/branches/route';
...
describe('src/app/api/github/branches/route.ts', () => {
  it('GET returns an HTTP response object', async () => {
    const handler = routeModule.GET;
    const request = new NextRequest('http://localhost/api/github/branches?take=10&page=1', {
      method: 'GET',
