...
import * as routeModule from '@/app/api/github/workflows/runs/route';
...
describe('src/app/api/github/workflows/runs/route.ts', () => {
  it('GET returns an HTTP response object', async () => {
    const handler = routeModule.GET;
    const request = new NextRequest('http://localhost/api/github/workflows/runs?take=10&page=1', {
      method: 'GET',
