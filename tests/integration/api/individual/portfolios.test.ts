...
import * as routeModule from '@/app/api/portfolios/route';
...
describe('src/app/api/portfolios/route.ts', () => {
  it('GET returns an HTTP response object', async () => {
    const handler = routeModule.GET;
    const request = new NextRequest('http://localhost/api/portfolios?take=10&page=1', {
      method: 'GET',
