...
import * as routeModule from '@/app/api/projects/[id]/milestones/route';
...
describe('src/app/api/projects/[id]/milestones/route.ts', () => {
  it('GET returns an HTTP response object', async () => {
    const handler = routeModule.GET;
    const request = new NextRequest('http://localhost/api/projects/id-test/milestones?take=10&page=1', {
      method: 'GET',
