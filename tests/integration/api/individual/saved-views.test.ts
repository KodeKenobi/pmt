...
import * as routeModule from '@/app/api/saved-views/route';
...
describe('src/app/api/saved-views/route.ts', () => {
  it('GET returns an HTTP response object', async () => {
    const handler = routeModule.GET;
    const request = new NextRequest('http://localhost/api/saved-views?take=10&page=1', {
      method: 'GET',
