...
import * as routeModule from '@/app/api/settings/backup/route';
...
describe('src/app/api/settings/backup/route.ts', () => {
  it('GET returns an HTTP response object', async () => {
    const handler = routeModule.GET;
    const request = new NextRequest('http://localhost/api/settings/backup?take=10&page=1', {
      method: 'GET',
