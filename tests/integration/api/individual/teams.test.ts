...
import * as routeModule from '@/app/api/teams/route';
...
describe('src/app/api/teams/route.ts', () => {
  it('GET returns an HTTP response object', async () => {
    const handler = routeModule.GET;
    const request = new NextRequest('http://localhost/api/teams?take=10&page=1', {
      method: 'GET',
