...
import * as routeModule from '@/app/api/teams/[teamId]/members/route';
...
describe('src/app/api/teams/[teamId]/members/route.ts', () => {
  it('GET returns an HTTP response object', async () => {
    const handler = routeModule.GET;
    const request = new NextRequest('http://localhost/api/teams/teamId-test/members?take=10&page=1', {
      method: 'GET',
