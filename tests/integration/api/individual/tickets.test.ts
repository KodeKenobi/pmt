...
import * as routeModule from '@/app/api/tickets/route';
...
describe('src/app/api/tickets/route.ts', () => {
  it('GET returns an HTTP response object', async () => {
    const handler = routeModule.GET;
    const request = new NextRequest('http://localhost/api/tickets?take=10&page=1', {
      method: 'GET',
