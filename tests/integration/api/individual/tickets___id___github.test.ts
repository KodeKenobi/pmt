...
import * as routeModule from '@/app/api/tickets/[id]/github/route';
...
describe('src/app/api/tickets/[id]/github/route.ts', () => {
  it('GET returns an HTTP response object', async () => {
    const handler = routeModule.GET;
    const request = new NextRequest('http://localhost/api/tickets/id-test/github?take=10&page=1', {
      method: 'GET',
